...
public class C01basic {
	public static void main(String[] args) {
		...
		//연산자 : 산술연산자/ 대입연산자/ 복합대입연산다/ 비교연산자/ 논리연산자/증감연산자/ 삼항연산자..
...
//		System.out.println(score + "점은 " + grade + "등급입니다.");
		...
		int eng = sc.nextInt();
		int math = sc.nextInt();
		double avarge = (double)(kor + eng + math)/3;
		String is합격 = (kor>=40&&eng>=40&&math>=40&&avarge>=70)?"합격":"불합격";
		System.out.println("is합격 : "+ is합격);
